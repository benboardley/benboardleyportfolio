...
//disabled={state.submitting}}
    return(
        <div className="content-center w-5/8 sm:w-1/2 mb-10 bg-gray-600 h-auto rounded-lg box-border  bg-opacity-70 p-10">
            ...
            <form
            action="https://formspree.io/f/mdoregpo"
            method="POST"
            >
            <div className="flex flex-col">
                <label for="name">Full Name</label>
                <input id="name" type="name" name="name" className="text-black"></input>
            </div>
            <div className="flex flex-col">
          ...
          {//  <ValidationError 
           // prefix="Email" 
            ...
            <input className="bg-gray-600 border-2 border-gray-800 w-40 mt-2 rounded-lg"type="submit" value="Send"></input>
        </form>
        </div>
    );
}
