...
function Education(){
  ...
  return (
    <div className=" lg:m-10 m-3 bg-gray-600 h-auto rounded-lg box-border overflow-auto shadow-md p-0 flex flex-col sm:flex-col bg-opacity-70 sm:float-right pr-2">
